...
struct Scene {
  ...
  // Raymarch the scene using SDFs. Returns true if hit; sets t, normal, and material id
  bool traceSDF(const Vector3& ro, const Vector3& rd, float& outT, Vector3& outNormal, int& outMat) const {
